...
('d0e1f2a3-b4c5-6789-defa-890123456789', 'HOT-LOT-002', 25, 1, 'QUEUED', '5NM_FINFE', 240, NULL, NOW() + INTERVAL '18 hours', 'NVIDIA', TRUE, NOW(), NOW()),
('e2f3a4b5-c6d7-8901-efab-123456789abc', 'HOT-LOT-003', 25, 1, 'PENDING', 'AI_ACCELERATOR', 200, NULL, NOW() + INTERVAL '14 hours', 'GOOGLE', TRUE, NOW(), NOW()),
...
('a4b5c6d7-e8f9-0123-abcd-345678901cde', 'HOT-LOT-005', 25, 1, 'PENDING', 'MOBILE_SOC', 190, NULL, NOW() + INTERVAL '20 hours', 'SAMSUNG', TRUE, NOW(), NOW()),
...
('f2a3b4c5-d6e7-8901-fabc-012345678901', 'WAFER-BATCH-104', 50, 2, 'QUEUED', 'MEMORY_DRAM', 280, NULL, NOW() + INTERVAL '30 hours', 'MICRON', FALSE, NOW(), NOW()),
('b5c6d7e8-f9a0-1234-bcde-456789012def', 'WAFER-BATCH-109', 50, 2, 'PENDING', 'GPU_DIE', 320, NULL, NOW() + INTERVAL '28 hours', 'NVIDIA', FALSE, NOW(), NOW()),
...
('d7e8f9a0-b1c2-3456-defa-678901234fab', 'WAFER-BATCH-111', 50, 2, 'PENDING', 'FPGA', 310, NULL, NOW() + INTERVAL '32 hours', 'XILINX', FALSE, NOW(), NOW()),
('e8f9a0b1-c2d3-4567-efab-789012345abc', 'WAFER-BATCH-112', 50, 2, 'QUEUED', 'MODEM_5G', 280, NULL, NOW() + INTERVAL '29 hours', 'QUALCOMM', FALSE, NOW(), NOW()),
...
('b4c5d6e7-f8a9-0123-bcde-234567890123', 'WAFER-BATCH-106', 100, 3, 'QUEUED', 'POWER_MANAGEMENT', 360, NULL, NOW() + INTERVAL '52 hours', 'TI', FALSE, NOW(), NOW()),
('f9a0b1c2-d3e4-5678-fabc-890123456bcd', 'WAFER-BATCH-113', 100, 3, 'PENDING', 'MICROCONTROLLER', 400, NULL, NOW() + INTERVAL '50 hours', 'NXP', FALSE, NOW(), NOW()),
...
('b1c2d3e4-f5a6-7890-bcde-012345678def', 'WAFER-BATCH-115', 100, 3, 'PENDING', 'RF_FRONTEND', 370, NULL, NOW() + INTERVAL '56 hours', 'SKYWORKS', FALSE, NOW(), NOW()),
('c2d3e4f5-a6b7-8901-cdef-123456789efa', 'WAFER-BATCH-116', 100, 3, 'QUEUED', 'WIFI_6E', 390, NULL, NOW() + INTERVAL '51 hours', 'MEDIATEK', FALSE, NOW(), NOW()),
('d3e4f5a6-b7c8-9012-defa-234567890fab', 'WAFER-BATCH-117', 100, 3, 'PENDING', 'BLUETOOTH_SOC', 360, NULL, NOW() + INTERVAL '55 hours', 'NORDIC', FALSE, NOW(), NOW()),
...
('c5d6e7f8-a9b0-1234-cdef-345678901234', 'WAFER-BATCH-107', 200, 4, 'QUEUED', 'ANALOG_MIXER', 600, NULL, NOW() + INTERVAL '72 hours', 'ADI', FALSE, NOW(), NOW()),
('f5a6b7c8-d9e0-2345-fabc-456789012bcd', 'WAFER-BATCH-119', 200, 4, 'PENDING', 'VOLTAGE_REGULATOR', 580, NULL, NOW() + INTERVAL '74 hours', 'MAXIM', FALSE, NOW(), NOW()),
...
('b7c8d9e0-f1a2-4567-bcde-678901234def', 'WAFER-BATCH-121', 200, 4, 'PENDING', 'LED_DRIVER', 560, NULL, NOW() + INTERVAL '76 hours', 'ONSEMI', FALSE, NOW(), NOW()),
('c8d9e0f1-a2b3-5678-cdef-789012345efa', 'WAFER-BATCH-122', 200, 4, 'QUEUED', 'DC_DC_CONVERTER', 590, NULL, NOW() + INTERVAL '73 hours', 'MPS', FALSE, NOW(), NOW()),
('d9e0f1a2-b3c4-6789-defa-890123456fab', 'WAFER-BATCH-123', 200, 4, 'PENDING', 'OP_AMPLIFIER', 570, NULL, NOW() + INTERVAL '75 hours', 'INTERSIL', FALSE, NOW(), NOW()),

-- Low Priority (Priority 5) - Internal/test lots
('d6e7f8a9-b0c1-2345-defa-456789012345', 'WAFER-BATCH-108', 300, 5, 'QUEUED', 'TEST_CHIPS', 900, NULL, NOW() + INTERVAL '168 hours', 'INTERNAL', FALSE, NOW(), NOW()),
('e0f1a2b3-c4d5-7890-efab-901234567abc', 'WAFER-BATCH-124', 300, 5, 'PENDING', 'CHARACTERIZATION', 880, NULL, NOW() + INTERVAL '170 hours', 'R&D', FALSE, NOW(), NOW()),
('f1a2b3c4-d5e6-8901-fabc-012345678bcd', 'WAFER-BATCH-125', 300, 5, 'PENDING', 'QUALIFICATION', 920, NULL, NOW() + INTERVAL '165 hours', 'QA', FALSE, NOW(), NOW()),
('a2b3c4d5-e6f7-9012-abcd-123456789cde', 'WAFER-BATCH-126', 300, 5, 'QUEUED', 'EXPERIMENTAL', 850, NULL, NOW() + INTERVAL '172 hours', 'R&D', FALSE, NOW(), NOW()),
('b3c4d5e6-f7a8-0123-bcde-234567890def', 'WAFER-BATCH-127', 300, 5, 'PENDING', 'PROCESS_DEV', 940, NULL, NOW() + INTERVAL '168 hours', 'ENG', FALSE, NOW(), NOW());
