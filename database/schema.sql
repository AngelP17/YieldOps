...
CREATE INDEX idx_metrology_results_tool_time
...
CREATE INDEX idx_vm_predictions_tool_time
    ON vm_predictions(tool_id, created_at DESC);

CREATE INDEX idx_vm_predictions_lot
...
CREATE INDEX idx_recipe_adjustments_tool_time
